...
import { createEditor } from "@/server/actions/editor-actions";
import { z } from "zod";
...
type CreateEditorFormData = z.infer<typeof createEditorSchema>;
...
export default function CreateEditorPage() {
  ...
  const onSubmit = async (data: CreateEditorFormData) => {
    setIsLoading(true);
    setError("");
    ...
    try {
      ...
      setError(
        error instanceof Error ? error.message : "Failed to create editor",
      );
    } finally {
      setIsLoading(false);
    }
  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center space-x-4">
        ...
        <div>
          <h1 className="text-3xl font-bold tracking-tight">Add New Editor</h1>
          <p className="text-muted-foreground">
            Create a new editor profile for your team
          </p>
        </div>
      </div>
        ...
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Basic details about the editor</CardDescription>
            </CardHeader>
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., Bob Smith" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input
                        type="email"
                        placeholder="e.g., bob@photography.com"
                        {...field}
                      />
                    </FormControl>
                    <FormMessage />
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    ...
                    <FormControl>
                      <Input placeholder="e.g., +1-555-0202" {...field} />
                    </FormControl>
                    <FormMessage />
                  </FormItem>
                )}
                ...
                render={({ field }) => (
                  <FormItem className="flex flex-row items-center space-y-0 space-x-3">
                    ...
                    <div className="space-y-1 leading-none">
                      <FormLabel>Active Editor</FormLabel>
                      <p className="text-muted-foreground text-sm">
                        Whether this editor is currently available for shoots
                      </p>
                    </div>
                  </FormItem>
                )}
